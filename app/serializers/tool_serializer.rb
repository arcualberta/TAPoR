class ToolSerializer < ActiveModel::Serializer
	attributes :id, :user_id, :name, :detail, :is_approved, :image_url, :creators_name, :creators_email, :creators_url, :star_average, :url, :last_updated, :nature, :language, :code, :repository, :thumb_url, :rating_count
